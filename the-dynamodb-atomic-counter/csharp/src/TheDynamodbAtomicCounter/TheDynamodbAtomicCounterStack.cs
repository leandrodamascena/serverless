...
namespace TheDynamodbAtomicCounter
{
    ...
    public class TheDynamodbAtomicCounterStack : Stack
    {
        ...
        internal TheDynamodbAtomicCounterStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
        {
            ...
            // MAY refactor this piece of code in the future.
            Dictionary<string, object> createParams = new Dictionary<string, object>();
            createParams.Add("TableName", _tableName);
            createParams.Add("Item", new Dictionary<string, object>());
            Dictionary<string, object> fieldAtomic = new Dictionary<string, object>();
            fieldAtomic.Add("S", "id");
            ((Dictionary<string, object>)createParams["Item"]).Add("atomicCounter", fieldAtomic);
            Dictionary<string, object> fieldCounter = new Dictionary<string, object>();
            fieldCounter.Add("N", "1");
            ((Dictionary<string, object>)createParams["Item"]).Add("counterValue", fieldCounter);
            createParams.Add("ConditionExpression", "attribute_not_exists(atomicCounter)");
            ...
            */
            ...
            {
                Value = _apiGatewayAtomic.Url + _defaultResource
            });
        }
    }
}
